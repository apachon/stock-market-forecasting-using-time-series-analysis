...
data = pd.read_csv('D:/Users/STR_APS/PyTest/Stock Market Forecasting Using Time Series Analysis/aaba.us.txt', sep=',', index_col='Date', parse_dates=['Date'], date_parser=dateparse).fillna(0)
